      ...
      <div class="box-company-profile">
        <div class="row mt-10">
          ...
          <div class="col-lg-4 col-md-12 text-lg-end">
            {{-- <a class="btn btn-apply btn-apply-big"
              href="javascript:;" onclick="document.getElementById('open-positions').scrollIntoView()">Open Positions</a></div> --}}
        </div>
      </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card-grid-2-image-left">
                            <div class="image-box">
                                {{-- <img src="{{ asset($job->company->logo) }}" alt="joblist"> --}}
                            </div>
                            <div class="right-info">
                                {{-- <a class="name-job" href="{{ route('companies.show', $job->company->slug) }}"> --}}
                                    {{-- {{ $job->company->name }} --}}
                                </a>
