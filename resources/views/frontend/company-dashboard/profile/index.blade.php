                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="website"
                                                class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}"value="{{ $companyInfo?->website }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email"
                                                class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }} "value="{{ $companyInfo?->email }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone"
                                                class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}"value="{{ $companyInfo?->phone }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            ...
                                            <select name="country" id=""
                                                class ="form-control form-icons select-active {{ $errors->has('country') ? 'is-invalid' : '' }}"value="{{ $companyInfo?->country }}">
                                                <option value="">Select</option>
                                                <option value="0">test1</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            ...
                                            <select name="state" id=""
                                                class ="form-control form-icons select-active {{ $errors->has('state') ? 'is-invalid' : '' }}"value="{{ $companyInfo?->state }}">
                                                <option value="">Select</option>
                                                <option value="0">test1</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            ...
                                            <select name="city" id=""
                                                class ="form-control form-icons select-active {{ $errors->has('city') ? 'is-invalid' : '' }}"value="{{ $companyInfo?->city }}">
                                                <option value="">Select</option>
                                                <option value="0">test1</option>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address"
                                                class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}"value="{{ $companyInfo?->address }}">
